...
public class CandidateView {
    ...
    public Candidate InputCandidateInformation(ArrayList<String> listCandidate) {
    ...
    public void listExperiences(ArrayList<Experience> list){
    ...
    public void listFreshers(ArrayList<Fresher> list){
        System.out.println("====== EXPERIENCE CANDIDATE =====");
    ...
    public void listInterns(ArrayList<Intern> list){
        System.out.println("====== EXPERIENCE CANDIDATE =====");
