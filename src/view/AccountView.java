...
public class AccountView {
    ...
    public static User createUserInfo(ArrayList<String> listAccounts) {
        User user = new User();
    ...
    public static User updateUser(ArrayList<String> listAccounts){
        User user = new User();
    ...
    public static User changePassword(ArrayList<String> listAccounts){
        User user = new User();
        user.setUserCode(DataInput.checkInputIntLimit("Enter user code: ", 1, listAccounts.size()));
        String password;        
        while (true) {            
